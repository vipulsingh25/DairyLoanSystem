<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateFarmerDetails.aspx.cs" Inherits="UserDetails_UpdateDetails" %>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <asp:Label runat="server">Email/Mobile no.</asp:Label>
    ...
    Display="Dynamic">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <asp:TextBox runat="server" class="form-control" ID="tb_Aadharnumber" placeholder="Aadhar Number" MaxLength="12" onkeypress="return isNumeric(event);" />
                ...
                <div class="form-group">
                  ...
                  <asp:TextBox runat="server" class="form-control" ID="tb_Pancardnumber" placeholder="Pancard Number" MaxLength="10" onkeyup="convertToUppercase(this);"/>
          ...
          <div class="col-md-5">
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Upload Aadhar Image</h3>
              </div>
              <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      <asp:FileUpload ID="AadharUpload" runat="server" accept=".jpg, .png, .pdf" />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server"
                    ControlToValidate="AadharUpload"
                    InitialValue=""
                    ErrorMessage="Required Field"
                    ForeColor="Red"
                    CssClass="validation-error1"
                ...
                <asp:Label runat="server" ID="Verify_msg" Style="color: #4CAF50;"></asp:Label>
                            ...
                            <div class="card-body">
                <div class="form-group">
                  <asp:Label ID="Photo_Pancard" runat="server">Upload Pancard Photo</asp:Label>
                  <div class="input-group">
                    <div class="custom-file">
                      <asp:FileUpload ID="PancardUpload" runat="server" accept=".jpg, .png, .pdf" />
                                                              <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server"
                    ControlToValidate="PancardUpload"
                    InitialValue=""
                    ErrorMessage="Required Field"
                    ForeColor="Red"
                    CssClass="validation-error1"
                ...
                <asp:Label runat="server" ID="Verify_msg2" Style="color: #4CAF50;"></asp:Label>
              </div>
                            <div class="card-body">
                <div class="form-group">
                  <asp:Label ID="Upload_Farmdoc" runat="server">Upload Farm Document</asp:Label>
                  <div class="input-group">
                    <div class="custom-file">
                      <asp:FileUpload ID="Farm_Doc" runat="server" accept=".jpg, .png, .pdf" />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                    ControlToValidate="Farm_Doc"
                    ErrorMessage="Required Field"
                    ForeColor="Red"
                    CssClass="validation-error1"
                    Display="Dynamic">
                ...
                <asp:Label runat="server" Style="color: #4CAF50;"></asp:Label>
              </div>
